...
<div className="fixed bottom-0 left-0 h-96 w-96 flex items-center justify-center z-50">   
  <div className="h-14 w-60 rounded-r-md flex justify-center items-center space-x-2">
    ...
    <div className=" flex justify-center items-center"><GitHubIcon className="scale-150 !fill-indigo-500 hover:!scale-125 hover:!fill-indigo-400"/></div> 
    <div className="h-14 w-16 rounded-xl flex justify-center items-center"><EmailIcon className="scale-150 !fill-indigo-500 hover:!scale-125 hover:!fill-indigo-400"/></div> 
  </div>
</div> 
