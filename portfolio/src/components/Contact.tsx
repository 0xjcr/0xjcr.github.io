...
const Contact = () => {
  return (
    ...
    <div className='-mb-10 md:-mb-0 mx-auto md:mx-0 fixed bottom-0 left-0 h-96 w-96 flex items-center justify-center z-30'>
      <div className='h-14 w-60 rounded-r-md flex justify-center items-center space-x-2'>
        <div className='h-14 w-16 rounded-xl flex justify-center items-center'>
          <a
            href='https://www.linkedin.com/in/jordanrollins/'
            target='_blank'
        ...
        <div className='h-14 w-16 rounded-xl flex justify-center items-center'>
          <a href='mailto:carpeomniavino@gmail.com'>
