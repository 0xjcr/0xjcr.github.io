        ...
        <div className="fixed top-1/2 md:top-1/3 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-full h-1 -mt-48 px-6 md:px-0 md:-mt-36 z-50">
            ...
            >
                ...
                <div className="flex flex-col justify-start items-center mt-4">
                    <div className="h-96 w-96 bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-gray-100 via-indigo-500 to-gray-800 rounded-full hover:scale-110 transition-transform duration-300 shadow-2xl shadow-indigo-500 " ><img className="md:scale-[200%] mt-40" src={AOE4} alt=""/></div>
                </div>
                ...
                <div className="w-full md:w-1/3 h-auto font-space text-gray-200 text-sm md:text-base">
                    ...
                    <br/>
                    <h3 className="text-sm md:text-lg">I collaborated with Chicago-based artist Justin VanGendren on this project, bringing my vision to life.</h3>
