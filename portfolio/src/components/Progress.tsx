...
export default function Progress() {
  ...
  const progressToOffset = useTransform(scrollYProgress, [0, 1], [circumference, 0]);
    ...
    <div className="fixed bottom-0 left-0 h-96 w-96 flex items-center justify-center z-10">
      <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
        <svg style={{ width: '200px', height: '200px' }} viewBox="0 0 60 60">
          <circle style={{ fill: 'none', stroke: '#D1D5DB', strokeWidth: '0.5', opacity: '0.2' }} cx="30" cy="30" r="25" />
          <motion.circle
            style={{
              fill: 'none',
              stroke: 'url(#gradient)', 
