      ...
      >
        ...
        <div className='flex flex-col justify-start items-center mt-4'>
          <div className='h-96 w-96 bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-gray-100 via-indigo-500 to-gray-800 rounded-full hover:scale-110 transition-transform duration-300 shadow-2xl shadow-indigo-500 '>
            <img className='md:scale-[200%] mt-40' src={YC2} alt='' />
          </div>
        </div>

        <div className='w-full md:w-1/3 h-auto font-space text-gray-200 text-sm md:text-base'>
          <div className='w-40 text-gray-400 text-sm whitespace-nowrap -mt-20 md:-mt-20 '>
            {' '}
            Recent Work
          </div>
          ...
          <h3 className='text-sm md:text-lg'>
            Empowering seamless coding collaboration and accelerated learning
            through interactive keystroke capture and exchange.
          </h3>
          <br />
          <h3 className='text-sm md:text-lg'>
            I contributed to the front-end development team, focusing on
            designing the user interface, and integrating dynamic logic and
            animations.
          </h3>
          <div className='flex justify-center items-center my-6 z-50'>
            <a
              href='https://github.com/phpmvk/YouCoder'
              target='_blank'
